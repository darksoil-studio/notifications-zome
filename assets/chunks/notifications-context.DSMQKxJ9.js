import{e as l,a as f}from"./context.Dv8Yf1uB.js";import{a,c as m,t as x}from"./property.-OmOMAsO.js";import{n as h,b as u,a as b,x as y,m as v}from"./notifications-client.B8NU7A1r.js";import{n as C}from"./context.BKjWNSn6.js";var w=Object.defineProperty,_=Object.getOwnPropertyDescriptor,o=(p,r,n,i)=>{for(var t=i>1?void 0:i?_(r,n):r,s=p.length-1,c;s>=0;s--)(c=p[s])&&(t=(i?c(r,n,t):c(t))||t);return i&&t&&w(r,n,t),t};let e=class extends h{constructor(){super(...arguments),this.zome="notifications"}connectedCallback(){if(super.connectedCallback(),!this.store){if(!this.role)throw new Error('<notifications-context> must have a role="YOUR_DNA_ROLE" property, eg: <notifications-context role="role1">');if(!this.client)throw new Error(`<notifications-context> must either:
