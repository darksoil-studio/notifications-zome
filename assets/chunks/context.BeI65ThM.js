import{i as b,u,j as d}from"./notifications-client.BwrMdjiO.js";const v=[b`
		.row {
			display: flex;
			flex-direction: row;
		}
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */function w({context:s,subscribe:e}){return(t,o)=>{typeof o=="object"?o.addInitializer(function(){new h(this,{context:s,callback:r=>{t.set.call(this,r)},subscribe:e})}):t.constructor.addInitializer(r=>{new h(r,{context:s,callback:i=>{r[o]=i},subscribe:e})})}}/**
 * @license
